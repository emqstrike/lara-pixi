...
<div class="uk-grid-match uk-child-width-expand@s" uk-grid>
	<div class="uk-width-1-3">
		<div class="uk-padding">
			<h5 class="uk-margin-remove uk-text-capitalize uk-text-bold">Change Image Color | <a href="javascript:void(0)" id="default-btn" >Default</a></h5>
			...
			@foreach($fontNames as $font)
				{{ dd($font) }}
				<!-- <button 
					class="uk-button uk-button-default uk-width-1-1 uk-margin-small {{ $font }} font-btn" 
					data-data="{{ $font }}" 
